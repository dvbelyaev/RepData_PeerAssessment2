---
title: "Health and Economic Impacts of the most hazardous Weather Events in the USA"
...
The original dataset was downloaded __`r data_date`__ as __`r data_file`__ archive:
...
Supplied dataset contains __`r data_size[1]`__ observations of weather events and __`r data_size[2]`__ variables. Next variables were used in the present exploration:
...
After this transformation the amount of events reduced to __`r dim(subdata)[1]`__ (about __`r round(100 * dim(subdata)[1]/data_size[1], digits = 1)`%__ of the source dataset).
...
* __`r round(fatalities_before, digits=2)`%__ of all fatalities;
* __`r round(injuries_before, digits=2)`%__ of all injuries;
* __`r round(propdmg_before, digits=2)`%__ of all property demages;
* __`r round(cropdmg_before, digits=2)`%__ of all crop demages.
...
* __`r round(fatalities_after, digits=2)`%__ of all fatalities;
* __`r round(injuries_after, digits=2)`%__ of all injuries;
* __`r round(propdmg_after, digits=2)`%__ of all property demages;
* __`r round(cropdmg_after, digits=2)`%__ of all crop demages.
